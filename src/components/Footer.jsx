        ...
        <footer className="bg-light pt-5">
            <div className="container">
                <div className="row gy-4">
                    ...
                    <div className="col-12 col-md-3 col-lg-3 text-center text-md-start"> {/* Aumenta a largura em md e lg */}
                        <h4 className="fw-bold mb-4">Institucional</h4>
                        <ul className="list-unstyled lead">
                            <li className='mb-2'><a href="#" >Home</a></li>
                            <li className='mb-2'><a href="#" >Orientador</a></li>
                    ...
                    <div className="col-12 col-md-3 col-lg-3 text-center text-md-start"> {/* Aumenta a largura em md e lg */}
                        ...
                        <ul className="list-unstyled lead">
                            <li className='mb-2'><a href="#" >Ensino</a></li>
                            <li className='mb-2'><a href="#" >Pesquisa</a></li>
                            <li className='mb-2'><a href="#" >Extensão</a></li>
                        </ul>
                    </div>
            ...
            <div className="bg-primary text-light text-center py-3 mt-4">
                <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center small">
                    ...
                    <a href="#" className="text-light text-decoration-none fw-bold">Políticas de Privacidade</a>
                </div>
            </div>
        </footer>
    );
